...
# 获取停用词
stop_words_filename = r'/Users/haojingkun/Downloads/Naive-Bayes/stopwords_cn.txt'
...
path = r'/Users/haojingkun/Downloads/Naive-Bayes/Database/SogouC/Sample'
contents = []
Mat = []
labels = []
    ...
    for filename2 in os.listdir(path2):
        ...
        with open(filename2, 'r', encoding='utf-8') as data:
            ...
            for line in lines:
                ...
                texts += line + '。'
        labels.append(label)
        seglist = jieba.cut(texts, cut_all=False)  # 精确模式
        # print(seglist)
